...
import PremiumBadge from '@/icons/premiun-badge'
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        <h2 className="font-bold text-2xl">Configuración del Dominio</h2>
      ...
      <div className="flex flex-col gap-3 mt-5">
        <div className="flex gap-4 items-center">
          ...
          <div className="flex gap-1 bg-cream rounded-full px-3 py-1 text-xs items-center font-bold text-[#000]">
            <PremiumBadge />
            Premium
          </div>
        </div>
      ...
      <div className="flex gap-5 justify-end">
        ...
        >
          <Loader loading={deleting}>Eliminar Dominio</Loader>
        </Button>
        <Button
          type="submit"
