  ...
  return (
    <div className={cn('flex flex-col gap-3', min ? 'mt-6' : 'mt-3')}>
      <div className="flex justify-between w-full items-center">
        {!min && <p className="text-xs text-gray-500">DOMINIOS</p>}
        <AppDrawer
          description="Añade la dirección de tu dominio para integrar tu chatbot"
          title="Añada el dominio de su negocio"
          onOpen={
