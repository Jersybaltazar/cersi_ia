    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
      <div className="lg:col-span-1">
        <Section
          ...
          message="Añada información de pago, actualice y modifique su plan"
        />
      </div>
      <div className="lg:col-span-2 flex justify-start lg:justify-center ">
        <Modal
          title="Elija un Plan"
          description="!Cuentanos sibre ti ! ¿A que te dedicas? Adaptemos tu experiencia para que se adapte mejor a ti."
          trigger={
            plan && plan === "STANDARD" ? (
