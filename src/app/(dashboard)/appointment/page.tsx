      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 h-0 gap-5">
        ...
        <div className="col-span-1">
          <Section
            ...
            message="Todas sus reservas para hoy se mencionaran a continuación."
          />
            ...
            bookingsExistToday.map((booking) => (
              ...
              >
                <CardContent className="p-0 flex">
                  <div className="w-4/12 text-xl bg-purple-500 py-10 flex justify-center items-center font-bold">
                    {booking.slot}
                  </div>
