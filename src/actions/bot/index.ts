      ...
      if (customerEmail) {
        ...
        if (checkCustomer && !checkCustomer.customer.length) {
          ...
          if (newCustomer) {
            ...
            const response = {
              ...
              }! Me alegra conectarme contigo. ¿En qué puedo ayudarte?`,
            };
            return { response };
          }
        }
          ...
          messages: [
            {
              ...
              if the customer agrees to book an appointment send them this link https://cersi-ia.vercel.app/portal/${id}/appointment/${checkCustomer?.customer[0].id}

              if the customer wants to buy a product redirect them to the payment page https://cersi-ia.vercel.app/portal/${id}/payment/${checkCustomer?.customer[0].id}
          `,
            },
            ...chat,
            {
        ...
        if (chatCompletion) {
          ...
          if (generatedLink) {
            ...
            const response = {
              role: "assistant",
              content: `¡Genial! Puedes pinchar el enlace para continuar.`,
              link: link.slice(0, -2),
            };
